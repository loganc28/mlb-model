...
UMP_DATA = {
    ...
    "Rob Drake":        {"rpg":9.1,"k_pct":0.22,"bb_pct":0.09,"note":"Slight over lean"},
    "Nic Lentz":        {"rpg":8.8,"k_pct":0.23,"bb_pct":0.08,"note":"Neutral — limited data"},
    "Brian Walsh":      {"rpg":8.9,"k_pct":0.22,"bb_pct":0.08,"note":"Neutral"},
    "Erich Bacchus":    {"rpg":8.8,"k_pct":0.23,"bb_pct":0.08,"note":"Neutral"},
    "Alex Tosi":        {"rpg":8.7,"k_pct":0.23,"bb_pct":0.08,"note":"Neutral — newer ump"},
    "Jeremy Riggs":     {"rpg":8.9,"k_pct":0.22,"bb_pct":0.09,"note":"Neutral"},
    "Adam Beck":        {"rpg":9.0,"k_pct":0.22,"bb_pct":0.09,"note":"Neutral"},
    "Junior Valentine": {"rpg":9.3,"k_pct":0.21,"bb_pct":0.09,"note":"High run ump"},
    "Brennan Miller":   {"rpg":8.8,"k_pct":0.23,"bb_pct":0.08,"note":"Neutral"},
