...
def build_html(data):
    ...
    return ('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            '<div class="meta">' + data["date"] + ' &nbsp;&middot;&nbsp; ' + str(data["total_games"]) + ' games &nbsp;&middot;&nbsp; Updated ' + gen + ' UTC &nbsp;&middot;&nbsp; Stats: 2025+2026 &nbsp;&middot;&nbsp; <a href="archive.html" style="color:#378ADD;text-decoration:none">Archive &rarr;</a></div>'
            '<div class="sum">'
